...
namespace Siltec.WebComponents.TagHelpers.DataTables
{
    ...
    public class DataTableColumnTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (dataTableContext.ModelColumnsProperties == null)
            {
                dataTableContext.ModelColumnsProperties = new List<ModelExpression>();
            }

            if (ColumnProperty != null)
            {
                dataTableContext.ModelColumnsProperties.Add(ColumnProperty);
            }
            else
            {
                if (!string.IsNullOrEmpty(PropertyName))
                {
                    ...
                    dataTableContext.ModelColumnsProperties.Add(new ModelExpression(PropertyName, explorer));
                }
            }
